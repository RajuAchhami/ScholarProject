...
const Events = () => {
  return (
    <div
      className="container px-4 xl:px-20 mx-auto flex flex-col pt-24 max-lg:pt-20 "
      id="events"
    >
      ...
      <div className=" grid lg:grid-rows-3 lg:grid-cols-1 md:grid-cols-2 md:gap-x-4 md:gap-y-24 max-md:gap-24 lg:gap-24">
